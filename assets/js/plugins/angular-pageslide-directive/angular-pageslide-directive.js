(function (root, factory) {
    ...
    angular
        ...
        .directive('pageslide', ['$document', '$timeout', 'PageSliderService', function ($document, $timeout, PageSliderService) {
            var defaults = {};
            ...
            return {
                ...
                link: function ($scope, el, attrs) {
                    ...
                    $scope.initPageSlider = function () {
	                    param.side = $scope.psSide || 'right';
	                    param.speed = $scope.psSpeed || '0.5';
	                    param.size = $scope.psSize || '300px';
	                    param.zindex = $scope.psZindex || 9999;
	                    param.className = $scope.psClass || 'ng-pageslide';
	                    //AISHA: added new class
	                    param.shadowClass = 'ng-pageslide-shadow';
	                    param.push = $scope.psPush === 'true';
	                    param.container = $scope.psContainer || false;
	                    param.keyListener = $scope.psKeyListener === 'true';
	                    param.bodyClass = $scope.psBodyClass || true;
	                    ...
	                    PageSliderService.numberOfCurrentOpenSlider++;
	                    initSlider();
                    };
                    ...
                    function psClose(slider, param) {
                        ...
                        //AISHA: ADDED THIS LINE
                        el.removeClass(param.shadowClass);
                    ...
                    //AISHA: THIS METHOD WAS EDITED
                    $scope.$watch('psSize', function(newValue, oldValue) {
                        if (oldValue != newValue && (newValue == '0%' || newValue == '0px')) {
                            psClose(slider, param);
