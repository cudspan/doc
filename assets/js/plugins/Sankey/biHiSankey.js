/**
 * Created by asthamalik on 7/1/15.
 */
...
d3.biHiSankey = function() {
    ...
    function className(link) {
        return link.className;
    }

    function isNewNode(link) {
        return link.isNewNode;
    }

    function priceIndex(link) {
        return link.priceIndex;
    }

    function classType(link) {
                ...
                if (leafNodes.indexOf(target) >= 0) {
                    ...
                    ancestorTargets.forEach(function (ancestorTarget) {
                        var ancestorLink = { source: leafNode,
                            ...
                            className: sourceLink.className,
                            classType: sourceLink.classType,
                            priceIndex: sourceLink.priceIndex,
                            isNewNode: sourceLink.isNewNode,
                ...
                if (leafNodes.indexOf(source) >= 0) {
                    ...
                    ancestorSources.forEach(function (ancestorSource) {
                        var ancestorLink = { source: ancestorSource,
                            ...
                            priceIndex: targetLink.priceIndex,
                            classType: targetLink.classType,
                            isNewNode: targetLink.isNewNode,
    ...
    function computeNodeYPositions(iterations) {
        ...
        function calculateYScaleFactor() {
            ...
            links.forEach(function (link) {
                ...
                if (linkLength / linkHeight < 4) {
                    yScaleFactor = 0.21 * linkLength / link.value;
                }
            });
        }
        ...
        function linkThicknessFactor(priceIndex){
            switch (priceIndex) {
                case (priceIndex > 10000):
                    //return 0.0015;
                    return 30;
                    break;
                case (priceIndex > 5000):
                    //return 0.0025;
                    return 25;
                    break;
                case (priceIndex > 1000):
                    //return 0.004;
                    return 20;
                    break;
                case (priceIndex > 500):
                ...
                case (priceIndex > 25):
                    ...
                    //return 0.28;
                    break;
                case (priceIndex > 1 && priceIndex < 2):
                    return 6;
                    //return 0.28;
                    break;
                default:
        ...
        function calculateLinkThickness() {
            links.forEach(function (link) {
                ...
                var linkFactor = linkThicknessFactor(link.priceIndex);
                //link.thickness = linkFactor * link.priceIndex;
                link.thickness = linkFactor;
                //link.thickness = .05 * link.priceIndex;
            });
        }
