 ...
 */
tagsInput.directive('tagsInput', ["$timeout", "$document", "$window", "$filter", "tagsInputConfig", "tiUtil", function($timeout, $document, $window, $filter, tagsInputConfig, tiUtil) {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            events
                ...
                .on('input-keydown', function(event) {
                    ...
                    if (shouldAdd) {
                        if (scope.globalScopeSearch == "true") {
                            scope.$root.$broadcast ("passingGlobalSearchTag", scope.newTag.text ());
                        } else {
                            scope.$root.$broadcast ("passingPlanSearchTag", scope.newTag.text ())
                        }
                    }
 ...
 */
tagsInput.directive('tiTagItem', ["$filter", "tiUtil", function($filter, tiUtil) {
    return {
        restrict: 'E',
        require: '^tagsInput',
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            scope.$getDisplayText = function() {
                return tiUtil.safeToString($filter('translate')(scope.data[options.displayProperty]));
            };
            scope.$getRemoveButton = function () {
 ...
 */
tagsInput.directive('autoComplete', ["$document", "$timeout", "$sce", "$q", "$filter", "tagsInputConfig", "tiUtil", function($document, $timeout, $sce, $q, $filter, tagsInputConfig, tiUtil) {
 ...
 */
tagsInput.directive('tiAutocompleteMatch', ["$sce", "$filter", "tiUtil", function($sce, $filter, tiUtil) {
    return {
        restrict: 'E',
        ...
        link: function(scope, element, attrs, autoCompleteCtrl) {
            ...
            scope.$getDisplayText =  function() {
                return tiUtil.safeToString($filter('translate')(scope.data[options.displayProperty || options.tagsInput.displayProperty]));
            };
        }
    };
}]);
...
tagsInput.run(["$templateCache", function($templateCache) {
    ...
    $templateCache.put ('ngTagsInput/tag-item.html',
        "<span ng-bind=\"$getDisplayText()\"></span> <a ng-show=\"$getRemoveButton\" class=\"remove-button\" ng-click=\"$removeTag()\" ng-bind=\"::$$removeTagSymbol\"></a>"
    );
